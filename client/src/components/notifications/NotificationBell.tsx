...
export const NotificationBell: React.FC = React.memo(() => {
  ...
  const handleNotificationClick = (notification: Notification) => {
    ...
    if (notification.action_url) {
      // Use a slight delay to ensure the modal closes first
      setTimeout(() => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="w-full max-w-md mx-auto max-h-[80vh] flex flex-col p-0">
          ...
          <div className="flex flex-col flex-1 min-h-0">
                ...
                <div className="divide-y">
                  {notifications.map((notification) => (
                    <div
                      key={notification.id}
                      className={cn(
                        "px-6 py-3 hover:bg-accent/50 transition-colors cursor-pointer",
            ...
            <div className="px-6 py-3 border-t bg-muted/50 space-y-2 flex-shrink-0 mt-auto">
