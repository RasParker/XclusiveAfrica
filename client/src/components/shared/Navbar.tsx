...
export const Navbar: React.FC = () => {
  ...
  const handleLogout = async () => {
    try {
      await logout();
      // Clear query cache to force re-renders
      queryClient.clear();
      ...
      // Clear cache and force navigation even if logout fails
      queryClient.clear();
      window.location.replace('/login');
    }
  };
  ...
  const navigationItems = [
    { label: 'Explore', href: '/explore', icon: Compass, show: true, active: location.pathname === '/explore' },
    { label: 'Feed', href: '/fan/feed', icon: Home, show: user?.role === 'fan', active: location.pathname === '/fan/feed' },
    { label: 'Dashboard', href: getDashboardLink(), icon: LayoutDashboard, show: !!user, active: location.pathname === getDashboardLink() },
    { label: 'My Profile', href: `/creator/${user?.username}`, icon: UserCircle, show: user?.role === 'creator', active: location.pathname === `/creator/${user?.username}` },
