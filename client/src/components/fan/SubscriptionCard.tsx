...
export const SubscriptionCard: React.FC<SubscriptionCardProps> = ({
  ...
  React.useEffect(() => {
    console.log('SubscriptionCard mounted with subscription:', subscription);
  }, [subscription]);
  ...
  return (
    <Card className="bg-gradient-card border-border/50">
          ...
          <div className="flex flex-row items-center justify-between gap-3 mt-4 pt-4 border-t border-border/50">
            ...
            <div className="flex gap-2">
              <Button
                ...
                size="sm"
                onClick={() => {
                  console.log('Desktop Manage Tier button clicked, subscription data:', subscription);
            ...
            <div className="px-4 pb-4 sm:px-6 sm:pb-6 space-y-4">
              ...
              <div className="space-y-2">
                <Button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    console.log('Mobile Manage Tier button clicked, subscription data:', subscription);
                    if (subscription && subscription.creator && subscription.tier) {
                      console.log('Opening tier management modal (mobile)');
                      setShowTierManagement(true);
                    } else {
                      console.error('Incomplete subscription data:', subscription);
                      alert('Unable to load tier management. Please refresh the page and try again.');
      ...
      {showTierManagement && subscription && (
        <TierManagementModal
