...
export const AdminDashboard: React.FC = () => {
  ...
  const { data: platformStats, isLoading: statsLoading } = useQuery({
    ...
    queryFn: () => adminApiRequest('/api/admin/platform-stats'),
  ...
  const { data: topCreators, isLoading: creatorsLoading } = useQuery({
    ...
    queryFn: () => adminApiRequest('/api/admin/top-creators'),
  ...
  const { data: recentReports, isLoading: reportsLoading } = useQuery({
    ...
    queryFn: () => adminApiRequest('/api/admin/reports'),
    refetchInterval: 30000, // Refresh every 30 seconds
  });
  ...
  const { data: systemHealth, isLoading: systemHealthLoading } = useQuery({
    ...
    queryFn: () => adminApiRequest('/api/admin/system-health'),
    refetchInterval: 30000, // Refresh every 30 seconds
  });
