...
const ManageCategories = () => {
  ...
  const handleCreateCategory = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const createdCategory = await adminApiRequest('/api/admin/categories', {
        method: 'POST',
  ...
  const handleUpdateCategory = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedCategory = await adminApiRequest(`/api/admin/categories/${editingCategory.id}`, {
        method: 'PUT',
        body: JSON.stringify({
  ...
  const handleDeleteCategory = async (categoryId: number) => {
    ...
    try {
      await adminApiRequest(`/api/admin/categories/${categoryId}`, {
        method: 'DELETE',
      });
