                      ...
                      <div className="w-full h-full relative overflow-hidden group">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="text-center p-4 space-y-3">
                            ...
                            <div className="space-y-2">
                              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold bg-white/10 text-white border border-white/30 backdrop-blur-md shadow-lg">
                            ...
                            <div className="pb-1">
                              <Button 
                                ...
                                className="bg-accent hover:bg-accent/90 text-white text-xs px-5 py-2 rounded-lg font-semibold shadow-2xl hover:shadow-accent/50 transition-all duration-300 hover:scale-105 relative overflow-hidden group/btn"
