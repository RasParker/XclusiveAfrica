  ...
  if (!hasAccess && post.tier?.toLowerCase() !== 'public' && (!user || post.creator_id !== user.id)) {
    ...
    return (
      <div className="min-h-screen bg-background">
          ...
          <div className="relative w-full aspect-video bg-black overflow-hidden">
            ...
            <div className="absolute inset-0">
              {thumbnailUrl ? (
                ...
                <div className="w-full h-full bg-gradient-to-br from-gray-900 to-gray-800 blur-md scale-110" />
              )}
            </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center p-6 space-y-4">
                ...
                <div className="space-y-2">
                  <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-semibold bg-white/10 text-white border border-white/20 backdrop-blur-sm">
                ...
                <Button 
                  ...
                  onClick={() => {
                    if (!user) {
                      ...
                      navigate(`/creator/${post.creator_username || post.creator?.username}`);
                    }
                  }}
                >
                  <span className="relative z-10 flex items-center gap-2">
                    ...
                    {!user ? 'Login to Unlock' : 'Subscribe to Access'}
                  </span>
        ...
        {/* Desktop Layout */}
        <div className="hidden md:flex min-h-screen justify-center">
          <div className="w-full max-w-8xl px-6 py-6">
            <div className="flex gap-6 justify-center">
              <div className="flex-1 max-w-6xl">
                ...
                <div className="relative w-full aspect-video bg-black rounded-lg overflow-hidden">
                  ...
                  <div className="absolute inset-0">
                    {thumbnailUrl ? (
                      <img 
                        ...
                        onError={(e) => {
                          const target = e.target as HTMLImageElement;
                          target.src = 'https://placehold.co/1920x1080/1f2937/FFFFFF?text=Premium+Content';
                        }}
                      />
                    ) : (
                      <div className="w-full h-full bg-gradient-to-br from-gray-900 to-gray-800 blur-md scale-110" />
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center p-6 space-y-4">
                      <div className="w-20 h-20 mx-auto bg-white/10 rounded-full flex items-center justify-center backdrop-blur-md border border-white/20 animate-pulse">
                        <svg className="w-10 h-10 text-accent drop-shadow-lg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                        </svg>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold bg-white/10 text-white border border-white/30 backdrop-blur-md shadow-lg">
                          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                          </svg>
                          {post.tier} Tier Required
                        </div>
                      </div>

                      <Button 
                        className="bg-accent hover:bg-accent/90 text-white px-8 py-3 rounded-lg font-semibold shadow-2xl hover:shadow-accent/50 transition-all duration-300 hover:scale-105 relative overflow-hidden group/btn"
                        onClick={() => {
                          if (!user) {
                            window.location.href = `/login?redirect=/video/${id}`;
                          } else {
